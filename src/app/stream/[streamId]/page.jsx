...
const page = ({ params }) => {
  ...
  return (
    ...
    <section className='bg-gray-800'>
      ...
      <div className='container m-auto py-4 px-2 relative mt-5'>
        <div className='flex'>
          ...
          <div className='channels-details w-[100%] md:w-[50%]'>
            <div className='flex gap-3'>
              ...
              <div className=' '>
                <h2 className='text-3xl text-white'>Sloan Lake Community Church</h2>
                <h2 className='text-xl text-white/70 mt-6'>Sloan Lake Community Church Streaming from China Grove , NC</h2>
                <button className='bg-primary rounded-md text-white text-xl py-2 px-4 mt-6'>Subscribe</button>
                <button className='bg-primary rounded-md text-white text-xl py-2 px-4 mt-6 ml-5' onClick={() => setPOpen(true)}>Pray Request</button>
              </div>
            </div>
          </div>
          {/* live chat  */}
          <div className='live-chat w-[100%] md:w-[50%]'>
            <div className='bg-gray-900 h-[35rem] rounded-md relative'>
              ...
              {
                open &&
                <div className='absolute top-[30%] left-7 right-7 bg-gray-900 rounded-md h-[15rem] px-2 shadow-md'>
